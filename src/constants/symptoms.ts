...
export const ALL_SYMPTOMS: SymptomDef[] = [
  ...
  { key: 'migraine',            label: 'Migraines',         emoji: '🤕', category: 'pain', color: '#C4506A', defaultVisible: true  },
  { key: 'neck_ache',           label: 'Neck aches',        emoji: '🧬', category: 'pain', color: '#E8748A', defaultVisible: true  },
  { key: 'ovulation_pain',      label: 'Ovulation pain',    emoji: '⭐', category: 'pain', color: '#E85555', defaultVisible: true  },
  ...
  { key: 'chills',              label: 'Chills',            emoji: '🥶', category: 'physical', color: '#6B9FD4', defaultVisible: true  },
  ...
  { key: 'hot_flashes',         label: 'Hot flashes',       emoji: '🔥', category: 'physical', color: '#E85555', defaultVisible: true  },
  ...
  { key: 'spotting',            label: 'Spotting',          emoji: '🩸', category: 'physical', color: '#E85555', defaultVisible: true  },
  ...
  // ─── DIGESTIVE ────────────────────────────────────────────────────────────
  { key: 'constipation',        label: 'Constipation',      emoji: '😣', category: 'digestive', color: '#B8899A', defaultVisible: true  },
  { key: 'diarrhea',            label: 'Diarrhea',          emoji: '🚻', category: 'digestive', color: '#B8899A', defaultVisible: true  },
  { key: 'appetite_up',         label: 'Cravings',          emoji: '🍫', category: 'digestive', color: '#F59E4A', defaultVisible: true  },
  { key: 'appetite_down',       label: 'Low appetite',      emoji: '🥗', category: 'digestive', color: '#7BAF8E', defaultVisible: true  },
  { key: 'gas',                 label: 'Gas',               emoji: '💨', category: 'digestive', color: '#7BAF8E', defaultVisible: true  },
  { key: 'hunger',              label: 'Hunger',            emoji: '🍗', category: 'digestive', color: '#F59E4A', defaultVisible: true  },
  ...
  { key: 'oily_skin',           label: 'Oily skin',         emoji: '✨', category: 'skin', color: '#F59E4A', defaultVisible: true  },
  { key: 'dry_skin',            label: 'Dry skin',          emoji: '🏜️', category: 'skin', color: '#B8899A', defaultVisible: true },

  // ─── CERVICAL ─────────────────────────────────────────────────────────────
  { key: 'cervical_firmness',   label: 'Cervical firmness', emoji: '⬡', category: 'cervical', color: '#7BAF8E', defaultVisible: true  },
  { key: 'cervical_opening',    label: 'Cervical opening',  emoji: '📍', category: 'cervical', color: '#E8748A', defaultVisible: true  },
  ...
  { key: 'cervical_sticky',     label: 'Sticky',            emoji: '🌊', category: 'cervical', color: '#7BAF8E', defaultVisible: true  },
  { key: 'cervical_creamy',     label: 'Creamy',            emoji: '💨', category: 'cervical', color: '#F4A7B5', defaultVisible: true  },
  { key: 'cervical_watery',     label: 'Watery',            emoji: '🌊', category: 'cervical', color: '#6B9FD4', defaultVisible: true  },
  { key: 'cervical_eggwhite',   label: 'Egg-white',         emoji: '🥚', category: 'cervical', color: '#F59E4A', defaultVisible: true  },
