...
import { Stack, StyledText, StyledScrollView, StyledPage, StyledHeader, StyledPressable, StyledSlider } from 'fluent-styles'
...
export default function CycleSettingsScreen() {
  ...
  return (
    <StyledPage flex={1} backgroundColor={Colors.background}>
      <StyledHeader title="Cycle Settings" titleAlignment="center" showBackArrow
        ...
        rightIcon={
          <StyledPressable onPress={handleSave} backgroundColor={Colors.primary}
            borderRadius={20} paddingHorizontal={16} paddingVertical={8}>
            <StyledText fontSize={14} fontWeight="700" color={Colors.textInverse}>Save</StyledText>
          </StyledPressable>
        }
      />
      ...
      <StyledScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40, gap: 20 }}
        ...
        {/* Cycle length */}
        <Stack backgroundColor={Colors.surface} borderRadius={20} padding={20} gap={20}
          ...
          <Stack backgroundColor={Colors.primaryFaint} borderRadius={16} padding={16}
            alignItems="center" gap={2}>
            <StyledText fontSize={42} fontWeight="800" color={Colors.primary}>{cycleDisplay}</StyledText>
            <StyledText fontSize={14} color={Colors.textSecondary}>days</StyledText>
          </Stack>
          <StyledSlider
            key="cycle-slider"
            value={cycleInitial}
            ...
            formatLabel={v => `${v}d`}
            colors={{ fill: Colors.primary, track: Colors.border, thumbBorder: Colors.primary, tooltipBg: Colors.primaryDark }}
            size="md"
            alwaysShowTooltip
          />
          <Stack horizontal justifyContent="space-between">
            <StyledText fontSize={11} color={Colors.textTertiary}>20 days (short)</StyledText>
            <StyledText fontSize={11} color={Colors.textTertiary}>45 days (long)</StyledText>
          </Stack>
        </Stack>
        ...
        <Stack backgroundColor={Colors.surface} borderRadius={20} padding={20} gap={20}
          ...
          <Stack backgroundColor={Colors.primaryFaint} borderRadius={16} padding={16}
            alignItems="center" gap={2}>
            <StyledText fontSize={42} fontWeight="800" color={Colors.primary}>{periodDisplay}</StyledText>
            <StyledText fontSize={14} color={Colors.textSecondary}>days</StyledText>
          </Stack>
          <StyledSlider
            key="period-slider"
          ...
          />
          <Stack horizontal justifyContent="space-between">
            <StyledText fontSize={11} color={Colors.textTertiary}>2 days</StyledText>
            <StyledText fontSize={11} color={Colors.textTertiary}>9 days</StyledText>
          </Stack>
        </Stack>
        ...
        <Stack backgroundColor={Colors.infoLight} borderRadius={16} padding={16} gap={8}>
          <Stack horizontal alignItems="center" gap={8}>
            ...
            <StyledText fontSize={13} fontWeight="600" color={Colors.textPrimary}>Tip</StyledText>
          </Stack>
          <StyledText fontSize={12} color={Colors.textSecondary} lineHeight={18}>
            As you log more cycles, Vela automatically refines predictions using your actual data. These are starting values only.
          </StyledText>
        </Stack>
      </StyledScrollView>
    </StyledPage>
